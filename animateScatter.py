...
class AnimatedScatter():
    ...
    def __init__(self,lons,lats,z,time,figname,confobj):
        ...
        self.mymap = Basemap(self.llcrnrlon, self.llcrnrlat,self.urcrnrlon, self.urcrnrlat,resolution='i',projection='merc')
